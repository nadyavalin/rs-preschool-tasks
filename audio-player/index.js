console.log(`Оцениваю свою работу на 60 баллов + 10 дополнительных баллов за 7ой пункт
(есть дополнительный функционал - реагирование масштаба картинки на звуки аудиоплеера)
