...
Для дополнительного функционала реализовано:
- возможность выбирать количество отображаемых фото в дополнительном поле;
- при клике на любое фото появляется поп ап с увеличенной версией фото +10 баллов
...
Реализовано собственное оформление, для дополнительного функционала реализована возможность выбирать количество отображаемых фото в дополнительном поле
`);
