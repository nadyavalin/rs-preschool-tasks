console.log(`Оцениваю свою работу на 60 баллов. Для дополнительного функционала реализована возможность выбирать количество отображаемых фото в дополнительном поле +10 баллов
1 Вёрстка +10
