console.log(`Оцениваю свою работу на 193 баллов:
...
i. При наличии авторизации вместо кнопки Check the Card будут отображаться данные пользователя и бейджи, как на дизайне LibraryCard after login in account. +1 (+1)
***!!!ПОКА НЕ РЕАЛИЗОВАНЫ БЕЙДЖИ!!!***`);
