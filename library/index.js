console.log(`Оцениваю свою работу на 186 баллов:
...
- Блок Favorites
i. Если пользователь еще не вошел в учетную запись, то при нажатии на любую кнопку Buy открывается модальное окно LOGIN. (+2) ***!!!НЕ до конца, после обновления снова Login!!!***
...
iii. Счетчик для Visits отображает, сколько раз пользователь проходил процесс авторизации, включая самый первый - регистрацию. (+2) ***!!!ПОКА СЧИТАЕТСЯ КОЛИЧЕСТВО ОБНОВЛЕНИЙ БРАУЗЕРА!!!***
